...
// these have weird numbers for legacy reasons
...
public:
    ...
    int MaxSpeed;  /* Captain I've given her all she's got! */
    ...
    int NoiseMakers;  // to distract the torpedos
    int CavitationFlag;
    int BaseNoise;  /* how noisey are we just sittin' here */
    float PSCS;  /* Passive Sonar Cross-section */
    float RadiatedNoise();  /* Tell 'em how loud we are. */
    void CheckForCavitation();  /* self explanatory */
